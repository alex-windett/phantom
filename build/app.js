...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _ActionConstants=__webpack_require__(/*! ../constants/ActionConstants */ 231);function bookmarks(){var state=arguments.length<=0||arguments[0]===undefined?[]:arguments[0];var action=arguments[1];switch(action.type){case _ActionConstants.CREATE_BOOKMARK:return _extends({},state,action.data);case _ActionConstants.EDIT_BOOKMARK:return{};case _ActionConstants.DELETE_BOOKMARK:var id=action.data;// debugger
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(/*! react */ 31);var _react2=_interopRequireDefault(_react);var _axios=__webpack_require__(/*! axios */ 234);var _axios2=_interopRequireDefault(_axios);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var BookmarkCreate=function(_React$Component){_inherits(BookmarkCreate,_React$Component);function BookmarkCreate(props){_classCallCheck(this,BookmarkCreate);var _this=_possibleConstructorReturn(this,Object.getPrototypeOf(BookmarkCreate).call(this,props));_this.state={inputValue:false,disabledButton:true,bookmarkData:false,isValidURL:false,url:_this.context.bookmarks.savedInputValue};return _this;}_createClass(BookmarkCreate,[{key:'componentWillMount',value:function componentWillMount(){this.checkURL(this.context.bookmarks.savedInputValue);}},{key:'checkURL',value:function checkURL(url){var _this2=this;_axios2.default.get(url).then(function(response){_this2.setState({isValidURL:true});}).catch(function(error){_this2.setState({isValidURL:false});});}},{key:'handleInputChange',value:function handleInputChange(event){var _this3=this;this.setState({inputValue:event.target.value},function(_){_this3.checkButton();_this3.checkURL(_this3.state.inputValue);});}},{key:'checkButton',value:function checkButton(){this.setState({disabledButton:this.state.inputValue!==''?false:true});}},{key:'submitForm',value:function submitForm(event){event.preventDefault();this.context.store.addBookmark(this.state.bookmarkData);}},{key:'showPagePreview',value:function showPagePreview(){if(this.state.isValidURL){return _react2.default.createElement('div',null,_react2.default.createElement('h3',null,'Page Preview'),_react2.default.createElement('p',null,'Is this the page you were after?'),_react2.default.createElement('iframe',{src:this.state.url,width:'500px',height:'500px'}));}else{return _react2.default.createElement('h3',null,'It looks like that isn\'t a page');}}},{key:'render',value:function render(){return _react2.default.createElement('div',{className:'decoration decoration__plain registration__form'},_react2.default.createElement('form',{refs:'addNewBookark',onSubmit:this.submitForm.bind(this)},_react2.default.createElement('input',{type:'text',defaultValue:this.context.bookmarks.savedInputValue,onChange:this.handleInputChange.bind(this)}),_react2.default.createElement('button',{disabled:this.state.disabledButton,className:'button button__primary',type:'submit'},'Confirm')),this.showPagePreview());}}]);return BookmarkCreate;}(_react2.default.Component);BookmarkCreate.contextTypes={bookmarks:_react2.default.PropTypes.array||_react2.default.PropTypes.object,store:_react2.default.PropTypes.object};exports.default=BookmarkCreate;
